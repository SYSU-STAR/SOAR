...
Interface::Interface() {
  pub =
      nh.advertise<quadrotor_msgs::PositionCommand>("/planning/pos_cmd_1", 10);
  pub2 =
      nh.advertise<quadrotor_msgs::PositionCommand>("/planning/pos_cmd_2", 10);
...
void Interface::messageCallback2(
