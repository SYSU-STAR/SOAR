...
public:
  ...
  static double computeCostPY(const Eigen::VectorXd& pose1, const Eigen::VectorXd& pose2);
  static double computePathLen(const Eigen::Vector3d& pose1, const Eigen::Vector3d& pose2);
